...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/tongwanming/podDemo'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'tongwanming' => '1623644929@qq.com' }
  s.source           = { :git => 'https://github.com/tongwanming/podDemo.git', :tag => s.version.to_s }
